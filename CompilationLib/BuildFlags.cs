...
{
    public readonly static List<string> Platforms = new List<string>() { "GUI_Generic_ESP32", "GUI_Generic_ESP32C3", "GUI_Generic_ESP32C6", "GUI_Generic_ESP32S3", "GUI_Generic_ESP32S2" };
